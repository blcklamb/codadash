  ...
  resources: {
    ...
    en: {
      translation: {
        ...
        draw: 'Draw',
        void: 'Void match',
        speedDesc: 'Type code within the time limit and check your speed and accuracy.',
        dailyDesc:
          'Practice with code that resets at midnight Korea time and track your completed days.',
        battleDesc:
          'Connect with a friend using an invite code and compete in a one-on-one typing match.',
        ...
        back: 'Back',
        next: 'Next',
        finishHeading: 'Practice complete',
